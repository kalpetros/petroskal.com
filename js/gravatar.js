// gravatarjs
// library for generating gravatar urls
...
function gravatar(email, options) {
	...
	url = base + md5(email) + "?" + params.join("&");
}
// Generate image url for a given email
gravatar("kalpetros@gmail.com", {size: 100});
// Provide source for gravatar img
